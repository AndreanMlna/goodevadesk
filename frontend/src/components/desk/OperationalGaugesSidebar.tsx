        ...
        <div className="double-bezel-inner p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-bold text-cyan-300 font-mono">{slaAdherence.toFixed(1)}%</span>
            </div>
        ...
        <div className="double-bezel-inner p-5 space-y-3.5 bg-gradient-to-b from-indigo-50/70 via-white to-indigo-50/30 dark:from-[#111827] dark:to-[#151c2e] border border-indigo-100/80 dark:border-transparent">
          ...
          {onNavigateToShelf && (
            <button
              ...
              className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 text-purple-200 text-xs font-semibold transition group cursor-pointer"
            >
              <span>Inspect 3D Knowledge Shelf</span>
              <div className="trailing-capsule !w-6 !h-6 bg-purple-500/20 border-purple-400/30 group-hover:bg-purple-500/40 group-hover:border-purple-300">
