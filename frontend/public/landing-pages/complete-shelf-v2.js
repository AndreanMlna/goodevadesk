import * as THREE from "three";
    ...
    const BOOKS = [
      {
        ...
        title: "RAG SOPs",
        roman: "I",
        discipline: "Policy Grounding",
        note: "Authoritative SOP grounding for hallucination-free support.",
        deck: "Operational knowledge base handbook: retrieve official SOP guidelines (SOP-BIL-2026, SOP-ENG-2026) to ground every AI ticket classification and suggested response.",
        binding: "Ultramarine cloth · copper foil",
        format: "148 × 216 mm · operational edition",
        theme: "RAG Grounding · truth from authoritative SOPs",
        ...
        height: 1.58,
        depth: 0.26,
        chapters: ["SOP Ingestion", "Policy Grounding", "Hallucination Defense"],
        seed: 11
      },
      {
        id: "claude-code",
        title: "Smart Triage",
        roman: "II",
        discipline: "SLA Automation",
        note: "Instant priority classification, sentiment analysis & SLA clock.",
        deck: "Automated triage manual: dynamically evaluate customer sentiment, calculate urgency scores (0.0 to 1.0), and enforce 1-hour critical response SLA deadlines.",
        binding: "Burnt-orange cloth · antique-gold foil",
        format: "156 × 228 mm · operational edition",
        theme: "Smart Triage · precision priority escalation",
        ...
        height: 1.46,
        depth: 0.29,
        chapters: ["Priority Rules", "Sentiment Triggers", "SLA Guardrails"],
        seed: 22
      },
      {
        id: "cursor",
        title: "Multi-Tenancy",
        roman: "III",
        discipline: "Tenant Isolation",
        note: "Sovereign organization boundaries via API keys & Prisma.",
        deck: "Multi-tenant security architecture: ensure every ticket query, Redis cache entry, and LLM classification is strictly filtered by organization_id.",
        binding: "Citron cloth · black gloss foil",
        format: "140 × 210 mm · operational edition",
        theme: "Multi-Tenancy · strict organization isolation",
        ...
        height: 1.52,
        depth: 0.22,
        chapters: ["API Authentication", "Tenant Scoping", "Leak Prevention"],
        seed: 33
      },
      {
        id: "antigravity",
        title: "Gemini AI",
        roman: "IV",
        discipline: "Adaptive LLM",
        note: "Sub-second reasoning with Google Gemini 3.5 Flash.",
        deck: "Enterprise LLM integration: non-blocking structured JSON responses, model deprecation auto-migration, and graceful fallback to local rule-engines.",
        binding: "Cobalt cloth · cool-silver foil",
        format: "162 × 240 mm · operational edition",
        theme: "Gemini AI · resilient neural generation",
        ...
        height: 1.68,
        depth: 0.25,
        chapters: ["Structured JSON", "Fallback Circuit", "Prompt Alignment"],
        seed: 44
      },
      {
        id: "figma",
        title: "Redis Cache",
        roman: "V",
        discipline: "Semantic Memory",
        note: "SHA-256 fingerprinting & Jaccard semantic caching.",
        deck: "High-throughput caching engine: hash normalized inquiries, achieve sub-millisecond cache hits on repeated questions, and reduce LLM token overhead.",
        binding: "Vermilion cloth · rose-gold foil",
        format: "150 × 220 mm · operational edition",
        theme: "Redis Cache · instant semantic recall",
        ...
        height: 1.48,
        depth: 0.3,
        chapters: ["Hash Normalization", "Semantic Similarity", "TTL Eviction"],
        seed: 55
      },
      {
        id: "framer",
        title: "HITL & RLHF",
        roman: "VI",
        discipline: "Agent Supervision",
        note: "Empowering human support agents with 1-click approval.",
        deck: "Human-in-the-loop governance: agents review AI drafted replies, edit when necessary, and provide thumbs-up/down ratings and corrective notes to refine future models.",
        binding: "Coral cloth · copper foil",
        format: "146 × 224 mm · operational edition",
        theme: "HITL & RLHF · human alignment in production",
        motif: "Folded frames",
        motifKey: "frames",
        ...
        height: 1.57,
        depth: 0.24,
        chapters: ["Draft Adoption", "Feedback Loops", "Continuous Learning"],
        seed: 66
      },
      {
        id: "xcode",
        title: "Python NLP",
        roman: "VII",
        discipline: "Deep Linguistics",
        note: "FastAPI microservice for entity & sentiment extraction.",
        deck: "Linguistic extraction microservice: parse invoice numbers, tracking IDs, stack traces, and sentiment intensity to enrich NestJS ticket metadata.",
        binding: "Icy-cyan cloth · aluminum foil",
        format: "158 × 232 mm · operational edition",
        theme: "Python NLP · specialized token analysis",
        ...
        height: 1.63,
        depth: 0.28,
        chapters: ["Entity Extraction", "Error Code Parsing", "Microservice Health"],
        seed: 77
      }
    ];

    // Canonical binary texture asset extracted per Clean Code & SoC standards
    const COVER_ATLAS_URL = new URL("./cover-atlas.webp", import.meta.url).href;
    ...
    coverAtlasImage.src = COVER_ATLAS_URL;
    ...
    function makeCoverTexture(book) {
      ...
      ctx.fillText(`GOODEVADESK  /  ${book.roman}`, canvasTexture.width / 2, 92);
    ...
    function makeFoilTexture(book) {
      ...
      ctx.fillText(`GOODEVADESK  /  ${pad(index)}`, 58, 70);
      ctx.globalAlpha = 0.7;
      ctx.lineWidth = 1;
      ctx.beginPath();
      ctx.moveTo(58, 86);
    ...
    function makeInteriorPageTextures(book) {
      ...
      return Array.from({ length: pageCount }, (_, pageIndex) => {
        ...
        ctx.fillText(`GOODEVADESK  /  ${book.roman}`, 48, 48);
        ctx.textAlign = "right";
        ...
        if (pageIndex === 0) {
          ...
          drawWrappedCanvasText(
            ctx,
            `${book.binding}. ${book.format}. Conceived as an authoritative operational guide for GoodevaDesk Enterprise AI Platform.`,
            54,
            306,
            44,
            28,
    ...
    function makeBackFoilTexture(book) {
      ...
      ctx.fillText(`GOODEVADESK  /  ${book.roman}`, 68, 82);
      ctx.globalAlpha = 0.72;
